  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="zymaApp.tag.home.createOrEditLabel" data-cy="TagCreateUpdateHeading">
            <Translate contentKey="zymaApp.tag.home.createOrEditLabel">Create or edit a Tag</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
