  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="zymaApp.article.home.createOrEditLabel" data-cy="ArticleCreateUpdateHeading">
            <Translate contentKey="zymaApp.article.home.createOrEditLabel">Create or edit a Article</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : articleEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="userIdLabel" for="article-userId">
                  <Translate contentKey="zymaApp.article.userId">User Id</Translate>
                </Label>
                <AvField
                  id="article-userId"
                  data-cy="userId"
              ...
              <AvGroup>
                <Label id="titleLabel" for="article-title">
                  <Translate contentKey="zymaApp.article.title">Title</Translate>
                </Label>
                <AvField
                  id="article-title"
                  data-cy="title"
              ...
              <AvGroup>
                <Label id="articleBodyLabel" for="article-articleBody">
                  <Translate contentKey="zymaApp.article.articleBody">Article Body</Translate>
                </Label>
                <AvField
              ...
              <AvGroup>
                <Label id="dateArticleLabel" for="article-dateArticle">
                  <Translate contentKey="zymaApp.article.dateArticle">Date Article</Translate>
                </Label>
                <AvField
              ...
              <AvGroup>
                <Label for="article-tags">
                  <Translate contentKey="zymaApp.article.tags">Tags</Translate>
                </Label>
                <AvInput
                  id="article-tags"
                  data-cy="tags"
              ...
              <AvGroup>
                <Label for="article-applicationUser">
                  <Translate contentKey="zymaApp.article.applicationUser">Application User</Translate>
                </Label>
                <AvInput
