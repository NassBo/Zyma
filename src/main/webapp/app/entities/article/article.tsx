  ...
  return (
    <div>
      <h2 id="article-heading" data-cy="ArticleHeading">
        <Translate contentKey="zymaApp.article.home.title">Articles</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="zymaApp.article.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="zymaApp.article.home.createLabel">Create new Article</Translate>
          </Link>
        </div>
      </h2>
          ...
          {articleList && articleList.length > 0 ? (
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="zymaApp.article.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('userId')}>
                    <Translate contentKey="zymaApp.article.userId">User Id</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('title')}>
                    <Translate contentKey="zymaApp.article.title">Title</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('articleBody')}>
                    <Translate contentKey="zymaApp.article.articleBody">Article Body</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('dateArticle')}>
                    <Translate contentKey="zymaApp.article.dateArticle">Date Article</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="zymaApp.article.applicationUser">Application User</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="zymaApp.article.home.notFound">No Articles found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
