...
export const ApplicationUserDeleteDialog = (props: IApplicationUserDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="zymaApp.applicationUser.delete.question">
        <Translate contentKey="zymaApp.applicationUser.delete.question" interpolate={{ id: applicationUserEntity.id }}>
