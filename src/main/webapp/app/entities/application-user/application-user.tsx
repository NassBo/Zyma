  ...
  return (
    <div>
      <h2 id="application-user-heading" data-cy="ApplicationUserHeading">
        <Translate contentKey="zymaApp.applicationUser.home.title">Application Users</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="zymaApp.applicationUser.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="zymaApp.applicationUser.home.createLabel">Create new Application User</Translate>
          </Link>
        </div>
      </h2>
        ...
        {applicationUserList && applicationUserList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="zymaApp.applicationUser.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="zymaApp.applicationUser.profilBanner">Profil Banner</Translate>
                </th>
                <th>
                  <Translate contentKey="zymaApp.applicationUser.profilBio">Profil Bio</Translate>
                </th>
                <th>
                  <Translate contentKey="zymaApp.applicationUser.internalUser">Internal User</Translate>
                </th>
                <th>
                  <Translate contentKey="zymaApp.applicationUser.friends">Friends</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="zymaApp.applicationUser.home.notFound">No Application Users found</Translate>
            </div>
          )
        )}
      </div>
